/*
    ...
    The GraphQL plugin for intellij and some other editors refuse to
    recognize the Upload scalar because it's built into apollo and 
    not a part of the user's schema definition
